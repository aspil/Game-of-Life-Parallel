...
int main(void){
	...
	// if (my_coords[0] == 0) {  // Uppermost row
	// 	if (my_coords[1] == 0)	// Leftmost process
	// 	if (my_coords[1] == comm_dims[1]-1) // Rightmost process
		
	// }
    // if(my_coords[0] == comm_dims[0] - 1){ // Downmost row
    //     if(my_coords[1] == 0)
    //     if (my_coords[1] == comm_dims[1]-1)
    // }


	// if ((my_coords[0] == 0) || (my_coords[0] == comm_dims[0] - 1)) {  // Uppermost row
	// 	if (my_coords[1] == 0) {	// Leftmost process
